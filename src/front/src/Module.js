...
function VariationSearchResultInDev1(props){
    ...
    const chromosome = props.searchChr;
    const searchStart = parseInt(props.searchStart);
    const searchEnd = parseInt(props.searchEnd);

    const narrowStart = parseInt(props.narrowStart);
    const narrowEnd = parseInt(props.narrowEnd);
    ...
    let chrMin = narrowStart, chrMax = narrowEnd;
    ...
    console.log(searchResultFiltered, searchResult)
...
function LocationSearchFilterContainer(props){
    ...
    function SVGRender (svg){
        ...
        const chrLocalUnit = findOptimalTick(chrMinMaxRange, 10);
        const chrLocalSubUnit = chrLocalUnit / 10;
        console.log(searchStart, searchEnd, chrMinMaxRange, chrLocalUnit)
